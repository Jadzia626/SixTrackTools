...
#Single distribution
./generateDist.py $PARTICLES $ENERGY $MACHINE $FORT13 $JOBS $FACTOR $EMITTANCE_X $EMITTANCE_Y $ALPHA_X $ALPHA_Y $BETA_X $BETA_Y $OFFSET_X $OFFSET_XP $OFFSET_Y $OFFSET_YP $DISPERSION_X $DISPERSION_XP $DISPERSION_Y $DISPERSION_YP $BUNCH $SPREAD $SEED
